...
void set_cali_gimbal_hook(const uint16_t yaw_offset, const uint16_t pitch_offset, const fp32 max_yaw, const fp32 min_yaw, const fp32 max_pitch, const fp32 min_pitch)
{
    ...
    gimbal_control.gimbal_pitch_motor.min_relative_angle = min_pitch;
		...
		/*gimbal_control.gimbal_yaw_motor.offset_ecd = 3215;
    gimbal_control.gimbal_yaw_motor.max_relative_angle = 8191;
    gimbal_control.gimbal_yaw_motor.min_relative_angle = 0;

    gimbal_control.gimbal_pitch_motor.offset_ecd = 6059;
    gimbal_control.gimbal_pitch_motor.max_relative_angle = 6979;
    gimbal_control.gimbal_pitch_motor.min_relative_angle = 5451;*/
...
static void gimbal_init(gimbal_control_t *init)
{
    ...
    init->gimbal_INT_angle_point = get_INS_angle_point();
		fp32 imu[3];
		imu[0] = *(init->gimbal_INT_angle_point);
		imu[1] = *(init->gimbal_INT_angle_point + 1);
		imu[2] = *(init->gimbal_INT_angle_point + 2);
...
static void gimbal_feedback_update(gimbal_control_t *feedback_update)
{
    if (feedback_update == NULL)
    {
		...
		/*feedback_update->gimbal_yaw_motor.offset_ecd = 3215;
    feedback_update->gimbal_yaw_motor.max_relative_angle = 8191;
    feedback_update->gimbal_yaw_motor.min_relative_angle = 0;

    feedback_update->gimbal_pitch_motor.offset_ecd = 6059;
    feedback_update->gimbal_pitch_motor.max_relative_angle = 6979;
    feedback_update->gimbal_pitch_motor.min_relative_angle = 5451;*/
		
    //云台数据更新
    feedback_update->gimbal_pitch_motor.absolute_angle = *(feedback_update->gimbal_INT_angle_point + INS_PITCH_ADDRESS_OFFSET);
		fp32 temp_pitch = feedback_update->gimbal_pitch_motor.absolute_angle;
    ...
    feedback_update->gimbal_yaw_motor.absolute_angle = *(feedback_update->gimbal_INT_angle_point + INS_YAW_ADDRESS_OFFSET);
		fp32 temp_yaw = feedback_update->gimbal_yaw_motor.absolute_angle;
